    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='E:/Documents/HKI/CNM/project/Attendace_management_system/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"E:\Documents\HKI\CNM\project\csvname\E:\Documents\HKI\CNM\project\Attendace_management_system\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = 'E:/Documents/HKI/CNM/project/Attendace_management_system/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"E:\Documents\HKI\CNM\project\Attendace_management_system\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'kushal' :
            if password == 'kushal14320':
                ...
                cs = 'E:/Documents/HKI/CNM/project/Attendace_management_system/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
